# Get minishift
wget https://github.com/minishift/minishift/releases/download/v1.0.0-beta.3/minishift-1.0.0-beta.3-linux-amd64.tgz;
tar -xf minishift-1.0.0-beta.3-linux-amd64.tgz;
mkdir ~/.local/bin;
